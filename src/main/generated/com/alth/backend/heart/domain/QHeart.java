...
public class QHeart extends EntityPathBase<Heart> {
    ...
    private static final long serialVersionUID = 1526513600L;
    ...
    public final com.alth.backend.member.domain.QMember member;

    public final com.alth.backend.post.domain.QPost post;
    ...
    public QHeart(Class<? extends Heart> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.alth.backend.member.domain.QMember(forProperty("member")) : null;
        this.post = inits.isInitialized("post") ? new com.alth.backend.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
    }
